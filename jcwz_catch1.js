...
[rewrite_local]
#阅读文章
https://ant.xunsl.com/v5/article/info.json 重写目标 https://ghproxy.com/https://raw.githubusercontent.com/Sinclair-Liu/js_scripts/main/jcwz_catch.js
#阅读时长（抓取一个即可）
https://ant.xunsl.com/v5/user/stay.json 重写目标 https://ghproxy.com/https://raw.githubusercontent.com/Sinclair-Liu/js_scripts/main/jcwz_catch.js
[MITM]
...
let wzbody= $.isNode() ? (process.env.wzbody1 ? process.env.wzbody1 : "") : ($.getdata('wzbody1') ? $.getdata('wzbody1') : "")
let wzbodyArr = []
let wzbodys = ""

let jc_timebody= $.isNode() ? (process.env.jc_timebody1 ? process.env.jc_timebody1 : "") : ($.getdata('jc_timebody1') ? $.getdata('jc_timebody1') : "")
let jc_timebodyArr = []
let jc_timebodys = ""
const jc_timeheader={
    ...
    if ($request.url.match(/\/v5\/user\/stay.json/)) {
        ...
        if (jc_timebody) {
            if (jc_timebody.indexOf(bodyVal) > -1) {
                ...
                $.setdata(jc_timebodys,'jc_timebody1');
