...
if(!$.getdata('soy_gk_authorization')&&$.getdata('soy_gk_authorization')==''){
    console.log(`\n【${$.name}】：未填写相对应的变量`);
    return;
}

soy_gk_authorization = $.getdata('soy_gk_authorization').split('@');
...
soy_gk_deviceid = $.getdata('soy_gk_deviceid').split('@');
