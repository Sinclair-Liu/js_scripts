...
let jkdhd= $.isNode() ? (process.env.jkdhd ? process.env.jkdhd : "") : ($.getdata('jkdhd1') ? $.getdata('jkdhd1') : "")
let jkdck= $.isNode() ? (process.env.jkdck ? process.env.jkdck : "") : ($.getdata('jkdck1') ? $.getdata('jkdck1') : "")
let jkdcks = ""
let jkdhds = ""
const logs =0;
