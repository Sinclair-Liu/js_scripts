...
// [task_local]
//#花果园
// 10 */1 * * * https://raw.githubusercontent.com/ctmd/main/app_hgy.js, tag=花果园APP, enabled=true
...
function qiandaogoodslist(timeout = 0) {
  return new Promise((resolve) => {
    let url = {
      url: `https://www.hzhuayangsz.com/api/user/get_shop_sign_list`,
      headers: {
        'Host': 'www.hzhuayangsz.com',
        'Content-Type': 'pplication/json;charset=utf-8',
        'Origin': 'https://www.hzhuayangsz.com',
...
function qiandao(num) {
  return new Promise((resolve) => {
    let url = {
      url: `https://www.hzhuayangsz.com/api/user/qiandao`,
      headers: {
        'Host': 'www.hzhuayangsz.com',
        'Content-Type': 'pplication/json;charset=utf-8',
        'Origin': 'https://www.hzhuayangsz.com',
