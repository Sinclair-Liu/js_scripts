...
let zqwzbody= $.isNode() ? (process.env.zqwzbody1 ? process.env.zqwzbody1 : "") : ($.getdata('zqwzbody1') ? $.getdata('zqwzbody1') : "")
let zqwzbodyArr = []
let zqwzbodys = ""

let zq_timebody= $.isNode() ? (process.env.zq_timebody1 ? process.env.zq_timebody1 : "") : ($.getdata('zq_timebody1') ? $.getdata('zq_timebody1') : "")
let zq_timebodyArr = []
let zq_timebodys = ""
const jc_timeheader={
    ...
    if ($request.url.match(/\/kandian.wkandian.com\/v5\/user\/stay.json/)) {
        ...
        if (zq_timebody) {
            if (zq_timebody.indexOf(bodyVal) > -1) {
                ...
                $.setdata(zq_timebodys,'zq_timebody1');
