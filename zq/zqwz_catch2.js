...
let zqwzbody= $.isNode() ? (process.env.zqwzbody2 ? process.env.zqwzbody2 : "") : ($.getdata('zqwzbody2') ? $.getdata('zqwzbody2') : "")
let zqwzbodyArr = []
let zqwzbodys = ""
    ...
    if ($request.url.match(/\/kandian.wkandian.com\/v5\/user\/stay.json/)) {
        ...
        if (zq_timebody) {
            if (zq_timebody.indexOf(bodyVal) > -1) {
                ...
                $.setdata(zq_timebodys,'zq_timebody2');
