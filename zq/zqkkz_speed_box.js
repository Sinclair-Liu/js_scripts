...
function openbox() {
    return new Promise((resolve) => {
        let url = {
            ...
            headers : {
    'Host': 'user.youth.cn',
        'Referer':'https://user.youth.cn/h5/fastAppWeb/lookEarn/index.html?'+zqlookStartbody1},
            }
