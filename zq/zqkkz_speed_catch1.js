...
if (!zqlookStartbody) {
 ...
 else if (process.env.spzqlookStartbody1 && process.env.spzqlookStartbody1.indexOf('@') > -1) {
            zqlookStartbodyArr = process.env.spzqlookStartbody1.split('@');
            console.log(`您选择的是用"@"隔开\n`)
 }
 else {
            zqlookStartbodys = [process.env.spzqlookStartbody1]
 };
