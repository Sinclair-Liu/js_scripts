...
let soy_ycsd_message = $.getdata('soy_ycsd_message')

!(async () => {

// if ($.isNode()) {

if(!$.getdata('soy_ycsd_jwt')&&$.getdata('soy_ycsd_jwt')==''){
    console.log(`\n【${$.name}】：未填写相对应的变量`);
    return;
}
    
soy_ycsd_jwt = $.getdata('soy_ycsd_jwt').split('@');
...
soy_ycsd_message = $.getdata('soy_ycsd_message').split('@');
