...
!(async () => {
    ...
    app_soy_ysysp_username.push($.getdata('soy_ysysp_username'))
    app_soy_ysysp_Code.push($.getdata('soy_ysysp_Code'))
    app_soy_ysysp_password.push($.getdata('soy_ysysp_password'))
